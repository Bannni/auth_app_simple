          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  className={`block w-full pl-10 pr-3 py-3 border ${passError ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 ${passError ? 'focus:ring-red-500' : 'focus:ring-blue-500'} focus:border-${passError ? 'red-500' : 'blue-500'} transition duration-150 ease-in-out`}
                  id="confirm-password"
                  type="password"
            ...
            <div>
              <button
                className={`group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white ${isLoading
                  ...
                  } focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out shadow-md hover:shadow-lg`}
                type="submit"
                disabled={isLoading}
              >
                {isLoading ? (
